      ...
      <div className="coupon-detail-card">
        ...
        <div className="coupon-detail-body">
          ...
          <div className="coupon-detail-info">
            ...
            {isLimitedUsage && (
              <div className="detail-section">
                <h3 className="detail-section-title">Kullanım Bilgileri</h3>
                <div className="detail-item-detail">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  ...
                  <div className="detail-content-detail">
                    <span className="detail-label-detail">Kalan Kullanım:</span>
                    <span className={`detail-value-detail ${isLowStock ? 'low-stock' : ''}`}>
                      {remainingUsage !== null && remainingUsage > 0 ? (
                        <>
                          <strong>{remainingUsage}</strong> kullanım hakkı kaldı
                          {isLowStock && (
                            <span className="low-stock-badge-detail">Az kaldı!</span>
                          )}
                        </>
                      ) : (
                        <span className="out-of-stock-detail">Kullanım hakkı kalmadı</span>
                      )}
                    </span>
                    <div className="usage-info-detail">
                      <span className="usage-text-detail">
                        {coupon.currentUsageCount} / {coupon.maxUsageCount} kullanıldı
                      </span>
                      <div className="usage-bar-detail">
                        <div 
                          className={`usage-bar-fill-detail ${isLowStock ? 'low-stock-bar' : ''}`}
